classdef ReaderCore < handle
    ...
    methods
        ...
        function set_metadatas(obj)
            ...
            obj.metadatas.('ax_offset') = str2double(l1(6));
            obj.metadatas.('ay_offset') = str2double(l1(7));
            obj.metadatas.('az_offset') = str2double(l1(8));
            obj.metadatas.('gx_offset') = str2double(l1(9));
            obj.metadatas.('gy_offset') = str2double(l1(10));
            obj.metadatas.('gz_offset') = str2double(l1(11));

            obj.metadatas.('cf_ok_mag') = l2(1);
            obj.metadatas.('sth_cf_mag') = l2(2);
            obj.metadatas.('hx_ASA') = str2double(l2(3));
            obj.metadatas.('hy_ASA') = str2double(l2(4));
            obj.metadatas.('hz_ASA') = str2double(l2(5));
            obj.metadatas.('hx_offset') = str2double(l2(6));
            obj.metadatas.('hy_offset') = str2double(l2(7));
            obj.metadatas.('hz_offset') = str2double(l2(8));
            obj.metadatas.('hx_escala') = str2double(l2(9));
            obj.metadatas.('hy_escala') = str2double(l2(10));
            obj.metadatas.('hz_escala') = str2double(l2(11));
